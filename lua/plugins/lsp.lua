	...
	config = function()
		...
		vim.api.nvim_create_autocmd("LspAttach", {
			...
			callback = function(event)
				...
				map("rg", require("fzf-lua").lsp_references, "[G]oto [R]eferences")
		...
		local servers = {
			...
			yamlls = {
				settings = {
					yaml = {
						schemaStore = {
							enable = false, -- dezactivat, folosim scheme manual
						},
						validate = true,
						hover = true,
						completion = true,
						schemas = {
							...
							-- Airflow
							["https://raw.githubusercontent.com/apache/airflow/main/airflow/config_templates/config.json"] = {
								"airflow/**/*.yaml",
								"airflow/**/*.yml",
							},
							-- Docker Compose
							...
							["https://raw.githubusercontent.com/dbt-labs/dbt-jsonschema/main/schemas/profile.json"] = {
								"profiles.yml",
							},
